            ...
            filterable: false, renderCell: (params) => {
                ...
                return (
                    ...
                    <>
                        ...
                        <Fab aria-label="add" color='error' size="small" onClick={() => onDelete(params.row._id)}>
                            <DeleteIcon />
                    ...
                    <>
                        ...
                        <Tooltip title="Admin">
                            ...
                            <Checkbox {...register("roleAdmin")} name='roleAdmin' checkedIcon={<AdminPanelSettings />}
                                ...
                                onChange={(e) => {
                                    (e.target.checked && params.row.roles.Admin == null) ? params.row.roles.Admin = 10 : params.row.roles.Admin = null;
                        ...
                        <Tooltip title="Trainer">
                            <Checkbox {...register("roleTrainer")} name='roleTrainer'
                                ...
                                onChange={(e) => {
                                    ...
                                    (e.target.checked && params.row.roles.Trainer == null) ? params.row.roles.Trainer = 5 : params.row.roles.Trainer = null
                                    setRowId(params.row._id);
                                }
                        ...
                        <Tooltip title="Client">
                            <Checkbox {...register("roleClient")} name='roleClient'
                                ...
                                onChange={(e) => {
                                    ...
                                    (e.target.checked && params.row.roles.Client == null) ? params.row.roles.Client = 2 : params.row.roles.Client = null
                                    setRowId(params.row._id);
