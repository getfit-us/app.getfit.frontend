...
import { Box, Button, CircularProgress, Grid, IconButton, Modal, Rating, TextField, Typography } from '@mui/material';
import React, { useState } from 'react'
import useProfile from '../../../hooks/useProfile';

const SaveWorkoutModal = ({modalFinishWorkout, handleCloseModal, status, clientId, onSubmit, setStartWorkout}) => {
