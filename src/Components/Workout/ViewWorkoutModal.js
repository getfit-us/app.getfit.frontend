...
import {  Box, Button, Fade, Grid,  IconButton,  Rating,  TextField,  Typography } from '@mui/material';
...
function getLabelText(value) {
  ...
  >
          ...
          >
            ...
            <DialogTitle id="scroll-dialog-title" sx={{textAlign: "center", justifyContent: "center",fontSize: "1.5rem",fontWeight: "bold"}}> {viewWorkout[0]?.name} </DialogTitle>
            <h3 style={{textAlign: "center", justifyContent: "center"}}>{new Date(viewWorkout[0]?.dateCompleted).toDateString()}</h3>
            ...
            <Rating
                ...
                <Grid item xs={12} sx={{textAlign: "center", justifyContent: "center"}}>{labels[viewWorkout[0]?.rating]}</Grid>
                


            <IconButton onClick={handleModal} sx={{position: "absolute",top: 0, right: 0,}}><Close/> </IconButton>
                    ...
                    <>
                      ...
                      {sets.length > 0 && sets.map((set) =>  <p>
                            ...
                            <Grid item xs={12} align="center" sx={{mt:1, mb:1}}>
                                ...
                                <>
                               <TextField defaultValue={Object.values(exercise)[1]} multiline label="Exercise Notes"/>
                                </>}
