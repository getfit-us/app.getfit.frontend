            ...
            <Paper elevation={3} marginTop={3} >
                ...
                <form noValidate onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <Grid container spacing={1} style={styles.container} >
                        ...
                        {showSets ? (
                            <>
                                <Grid item xs={6} sm={6} sx={{ ml: 1, mr: 1 }}>
                                    ...
                                    <TextField  {...register("date")} fullWidth InputLabelProps={{ shrink: true, required: true }} type='date' name='date'
                                        onChange={(e) => {
                                ...
                                <Grid item xs={6} sm={6}>
                                    <TextField {...register("WorkoutType")} name="WorkoutType" fullWidth select label="Exercise Type" defaultValue="push">
                                ...
                                < Grid item xs={12} >
                                    <Typography sx={{ textAlign: 'center' }}>Workout Rating</Typography>
                                    <Rating
                                        name="hover-feedback"
                                        value={ratingValue}
                                        precision={0.5}
                        ...
                        {showSets ? <Grid item sx={{mb: 3}} >  <Button onClick={onSubmit} startIcon={<Save />} variant='contained' color='primary' >
                                    ...
                                    return (
                                        ...
                                        >
                                            <TableCell component="th" scope="row">
                                                {<Fab color='error' sx={{ align: 'start', mr: 2 }}
                                                    onClick={() => {
